...
class InMemoryTaskManagerTest {
    ...
    void shouldUpdateEpic() {
        final Epic epic1 = new Epic("Epic1", "Description");
        final Epic epic2 = new Epic("Epic2", "Description2");
    ...
    void shouldUpdateSubTask() {
        ...
        final SubTask subTask1 = new SubTask(epic1, "Sub1","Description1", TaskStatus.NEW);
        final SubTask subTask2 = new SubTask(null, "Sub3","Description3", TaskStatus.DONE);
    ...
    void shouldUpdateEpicStatus() {
        ...
        final SubTask subTask1 = new SubTask(epic1, "Sub1","Description1", TaskStatus.NEW);
        final SubTask subTask2 = new SubTask(epic1, "Sub2","Description2", TaskStatus.NEW);
        ...
        SubTask newSsubTask1 = new SubTask(null, "Sub1","Description1", TaskStatus.IN_PROGRESS);
        SubTask newSsubTask2 = new SubTask(null, "Sub1","Description2", TaskStatus.DONE);
    ...
    void shouldRemoveTask() {
        final Task task1 = new Task("Task1", "Description1", TaskStatus.NEW);
        final Task task2 = new Task("Task2", "Description2", TaskStatus.NEW);
    ...
    void shouldRemoveEpic() {
        ...
        final SubTask subTask1 = new SubTask(epic1, "Sub1","Description1", TaskStatus.NEW);
        final SubTask subTask2 = new SubTask(epic1, "Sub2","Description2", TaskStatus.NEW);
        final SubTask subTask3 = new SubTask(epic2, "Sub3","Description3", TaskStatus.NEW);
    ...
    void shouldClearTasks() {
        final Task task1 = new Task("Task1", "Description", TaskStatus.NEW);
        final Task task2 = new Task("Task2", "Description", TaskStatus.NEW);
